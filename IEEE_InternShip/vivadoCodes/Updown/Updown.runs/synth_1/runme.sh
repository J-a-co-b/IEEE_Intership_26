...
HD_PWD='C:/Vivado_projects/IEEE_InternShip/vivadoCodes/Updown/Updown.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log updownCounter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source updownCounter.tcl
