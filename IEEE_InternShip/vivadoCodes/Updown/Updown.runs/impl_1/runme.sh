...
HD_PWD='C:/Vivado_projects/IEEE_InternShip/vivadoCodes/Updown/Updown.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log updownCounter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source updownCounter.tcl -notrace
